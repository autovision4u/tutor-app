...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 h-14 bg-background border-b flex items-center px-4">
        <Button
          variant="ghost"
          size="icon"
        ...
        <div className="flex items-center gap-2 ml-3">
          ...
          <span className="font-semibold">TutorApp</span>
        </div>
      </div>
      ...
      >
        <div className="h-14 flex items-center px-6 border-b">
          <Link href="/dashboard" className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold tracking-tight">TutorApp</span>
          </Link>
        </div>
